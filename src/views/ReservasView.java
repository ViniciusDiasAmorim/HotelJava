...
public class ReservasView extends JFrame {
	...
	private RegistroHospede registroHospede;
	...
	private void passaId(int id) {
		String passaId = String.valueOf(id);
		if (registroHospede == null) {
			registroHospede = new RegistroHospede();
			registroHospede.setVisible(true);
			registroHospede.recebendoId(passaId);
		} else {
			registroHospede.setVisible(true);
			registroHospede.setState(RegistroHospede.NORMAL);
			registroHospede.recebendoId(passaId);
		}
	}
}
